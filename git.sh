#!/bin/bash
#
# Description: Github formatted patch extractor script, put inside root directory of a repository, chmod +x /path/to/script/file/git.sh
# Usage : ./git.sh author_name output_root_directory

# Copyright 2014 by Lasse Schuirmann <lasse.schuirmann@gmail.com>
#                   Giriraj Sharma <giriraj.sharma27@gmail.com>
# License: GPL 3
